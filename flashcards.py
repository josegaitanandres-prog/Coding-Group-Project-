...
state_boundaries = {
    ...
    "Alaska": [
        ...
        (97, 478), (86, 484), (71, 492), (65,
                                          491), (73, 483), (80, 476), (73, 469),
        (66, 468), (67, 462), (61, 460), (60,
                                          455), (57, 446), (64, 436), (78, 438),
        (79, 427), (67, 424), (65, 419), (63,
                                          414), (73, 412), (77, 413), (77, 417),
        (84, 416), (79, 408), (78, 404), (75,
                                          399), (74, 395), (85, 394), (87, 388),
    ...
    "California": [
        (51, 126), (72, 132), (90, 137), (97,
                                          140), (94, 156), (91, 164), (91, 171),
        (88, 180), (87, 186), (91, 192), (101,
                                          207), (113, 225), (126, 244), (137, 259),
        (138, 268), (141, 274), (136, 277), (135, 281), (132, 285), (131, 290),
        (132, 294), (129, 296), (112, 295), (100, 293), (97, 284), (94, 276),
        (90, 272), (88, 272), (86, 266), (81,
                                          266), (75, 258), (62, 251), (62, 245),
        (61, 240), (58, 231), (54, 222), (53,
                                          217), (55, 212), (52, 209), (52, 201),
        (53, 197), (48, 191), (47, 184), (44,
                                          177), (43, 170), (45, 165), (44, 156),
    ...
    "Hawaii": [(224, 444), (221, 456), (233, 456), (236, 446), (224, 444),
               (252, 460), (255, 466), (262, 466), (258,
                                                    457), (252, 460), (272, 466),
               (269, 469), (278, 471), (278, 468), (273,
                                                    466), (287, 478), (294, 479),
               (292, 474), (287, 473), (282, 472), (282,
                                                    476), (287, 477), (298, 486),
               (296, 493), (294, 496), (296, 504), (298,
                                                    511), (304, 508), (312, 503),
    ...
    "Maine": [
        (662, 118), (664, 106), (670, 102), (675,
                                             99), (675, 94), (684, 88), (688, 86),
        (693, 80), (691, 74), (688, 74), (687,
                                          70), (682, 67), (677, 52), (672, 46),
        (663, 48), (660, 46), (656, 53), (654,
                                          68), (653, 78), (649, 85), (658, 115),
        (662, 118)],
    "Michigan": [
        ...
        (459, 84), (462, 86), (458, 92), (470,
                                          95), (476, 99), (493, 92), (497, 96),
        (505, 96), (509, 101), (499, 103), (506, 108), (515, 112), (517, 121),
        (518, 126), (513, 133), (513, 138), (520, 136), (524, 132), (528, 137),
        (529, 150), (527, 155), (522, 167)],
    "Minnesota": [
        (363, 63), (382, 62), (384, 57), (387,
                                          57), (389, 65), (399, 70), (405, 67),
        (415, 73), (425, 76), (430, 73), (440,
                                          75), (419, 95), (415, 103), (413, 110),
    ...
    "Nevada": [
        (98, 140), (166, 155), (152, 233), (148,
                                            247), (142, 244), (138, 260), (95, 197),
    ...
    "North Carolina": [
        ...
        (624, 234)],
    "North Dakota": [
        (291, 61), (318, 62), (339, 63), (361,
                                          63), (363, 80), (365, 84), (368, 110),
        (289, 109), (291, 61)],
    "Ohio": [
    ...
    "Oklahoma": [
        ...
        (289, 259), (288, 251)],
    "Oregon": [
        (75, 62), (83, 68), (84, 76), (96, 77), (103,
                                                 80), (113, 79), (127, 81), (146, 84),
        (151, 91), (140, 105), (139, 110), (141,
                                            114), (137, 119), (132, 145), (50, 125),
    ...
    "Utah": [
        ...
        (168, 155)],
    "Vermont": [
        (625, 95), (644, 91), (647, 99), (644,
                                          102), (642, 117), (642, 127), (635, 130),
    ...
    "Washington": [
        ...
        (84, 75), (83, 68), (74, 61), (76, 41), (74,
                                                 28), (95, 38), (93, 48), (99, 40),
        (98, 24)],
    "West Virginia": [
...
class FlashcardApp(tk.Tk):
    ...
    def set_return_action(self, callback=None):
        ...
        if callback is not None:
            self.bind("<Return>", lambda event: callback())
    ...
    def show_welcome(self):
        ...
        self.set_return_action(self.validate_initials)
    ...
    def show_flashcard(self):
        ...
        if self.answer_mode.get() == "text":
            self.set_return_action(self.check_answer)
    ...
    def point_in_polygon(self, x, y, points):
        ...
        for i in range(len(points)):
            ...
            if intersects:
                x_intersection = (xj - xi) * (y - yi) / (yj - yi + 1e-9) + xi
                if x < x_intersection:
                    inside = not inside
            j = i
        return inside

    def point_to_segment_distance_sq(self, px, py, ax, ay, bx, by):
        abx = bx - ax
        aby = by - ay
        apx = px - ax
        apy = py - ay
    ...
    def get_label_point(self, points):
        ...
        candidates = []
        if self.point_in_polygon(centroid_x, centroid_y, points):
            candidates.append((centroid_x, centroid_y))

        # Grid-search points inside the polygon and pick the most interior point.
        width = max_x - min_x
        height = max_y - min_y
        step = max(2.0, min(width, height) / 12.0)
        ...
        for cx, cy in candidates:
            ...
            for i in range(len(points)):
                ...
                dist_sq = self.point_to_segment_distance_sq(
                    cx, cy, ax, ay, bx, by)
    ...
    def draw_map(self, highlight_code=None, selected_code=None):
        ...
        # Fit all states into the visible map area and center them.
        all_points = []
        for info in STATES.values():
            state_name = info["name"]
            if state_name in state_boundaries:
                all_points.extend(state_boundaries[state_name])
        ...
        padding = 18
        fit_width = max(1, map_width - (2 * padding))
        fit_height = max(1, map_height - (2 * padding))
        scale = min(fit_width / src_width, fit_height / src_height)

        x_offset = map_left + \
            (map_width - (src_width * scale)) / 2 - (min_x * scale)
        y_offset = map_top + \
            (map_height - (src_height * scale)) / 2 - (min_y * scale)
        ...
        for code, info in STATES.items():
            ...
            polygons = self.split_closed_polygons(points)
            ...
            if width >= 22 and height >= 14:
                cx, cy = self.get_label_point(points)
                state_label_points[code] = (cx, cy)
        ...
        for code, (dx, dy) in callout_states.items():
            if code not in STATES:
                continue
            if code not in state_label_points:
                state_name = STATES[code]["name"]
                if state_name not in state_boundaries:
                    continue
                base_points = self.get_scaled_points(
                    state_boundaries[state_name],
                    scale=scale,
                    x_offset=x_offset,
                    y_offset=y_offset
                )
                ax, ay = self.get_label_point(base_points)
            else:
                ax, ay = state_label_points[code]

            tx = ax + dx
            ty = ay + dy
            text_anchor = "w" if dx >= 0 else "e"
            line_end_x = tx - 6 if dx >= 0 else tx + 6
    ...
    def make_choices(self, key, current_code):
        ...
        wrong_answers = [
            answer for answer in all_answers if answer != correct_answer]
